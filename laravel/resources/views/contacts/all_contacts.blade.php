							...
							<div class="box box-primary">
								<div class="box-header">
									...
									<div class="pull-right">
										<a href="{{ url('/') }}/contact/create" class="btn btn-primary"><i class="fa fa-plus"></i> Create Contact</a>
									</div>
								</div>
								<div class="box-body no-padding">
									<table class="table table-condensed display" id="table_id">
										...
										<tr id="idContactRow_{{$contact->id}}">
											...
											<td>
												<a href="{{ url('/') }}/contact/{{$contact->id}}" data-id="{{$contact->id}}" class="btn btn-sm btn-default">View</a>
												<a href="{{ url('/') }}/contact/{{$contact->id}}/edit" class="btn btn-sm btn-default"><i class="fa fa-edit"></i></a>
