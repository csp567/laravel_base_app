				...
				<div class="row">
					<div class="col-md-5">
						<div class="box box-primary">
							...
							<div class="box-body">
								<?php echo Form::open( [ 'url' => url('/') . '/contact/store', 'files'=>'true' ] ); ?>
								{{ csrf_field() }}
								<div class="form-group has-{{ $errors->has('first_name') ? 'error' : 'feedback' }}">
									<label>First Name</label>
									<?php echo Form::text( 'first_name', old('first_name'), [ 'class' => 'form-control', 'placeholder' => 'First Name (Required)' ] ); ?>
								...
								<div class="form-group has-{{ $errors->has('middle_name') ? 'error' : 'feedback' }}">
									...
									<?php echo Form::text( 'middle_name', old('middle_name'), [ 'class' => 'form-control', 'placeholder' => 'Middle Name' ] ); ?>
									<span class="glyphicon glyphicon-user form-control-feedback"></span>
								...
								<div class="form-group has-{{ $errors->has('last_name') ? 'error' : 'feedback' }}">
									...
									<?php echo Form::text( 'last_name', old('last_name'), [ 'class' => 'form-control', 'placeholder' => 'Last Name (Required)' ] ); ?>
									<span class="glyphicon glyphicon-user form-control-feedback"></span>
								...
								<div class="form-group has-{{ $errors->has('primary_phone') ? 'error' : 'feedback' }}">
									...
									<?php echo Form::tel( 'primary_phone', old('primary_phone'), [ 'class' => 'form-control', 'placeholder' => 'Primary Phone (Required)' ] ); ?>
								...
								<div class="form-group has-{{ $errors->has('secondary_phone') ? 'error' : 'feedback' }}">
									...
									<?php echo Form::tel( 'secondary_phone', old('secondary_phone'), [ 'class' => 'form-control', 'placeholder' => 'Secondary Phone' ] ); ?>
