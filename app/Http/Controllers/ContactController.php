...
class ContactController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if($objResult->exists) {
			return redirect('/contact/create')->with( Success, '<a href="/contact/' . $objResult->id . '">' . $request['first_name'] . ' ' . $request['last_name'] . '</a> Contact details saved successfully!' );
		}
		return redirect('/contact/create')->with( Error, 'Looks like somethig broken to our side. Try after sometime.' );
	...
	public function update(Request $request, Contact $contact)
	{
		...
		if( $boolResult ) {
			return redirect('/contact/' . $request->id . '/edit')->with( Success, '<a href="/contact/' . $request->id . '">' . $request['first_name'] . ' ' . $request['last_name'] . '</a> Contact details updated successfully!' );
		}
		return redirect('/contact/' . $request->id . '/edit')->with( Error, 'Looks like somethig broken to our side. Try after sometime.' );
	}
